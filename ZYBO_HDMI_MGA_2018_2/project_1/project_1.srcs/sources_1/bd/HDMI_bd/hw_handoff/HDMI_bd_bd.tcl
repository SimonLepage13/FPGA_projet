...
# module references:
# MessageSend, boite, comparaison_couleurs, moyennage, zonePeau
...
proc create_root_design { parentCell } {
  ...
  set LED_cerne1 [ create_bd_port -dir O LED_cerne1 ]
  set LED_cerne2 [ create_bd_port -dir O LED_cerne2 ]
  ...
  connect_bd_net -net MessageSend_0_tx [get_bd_ports UART_OUT] [get_bd_pins MessageSend_0/tx]
  connect_bd_net -net boite_0_PIXEL_OUT [get_bd_pins boite_0/PIXEL_OUT] [get_bd_pins rgb2dvi_0/vid_pData]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins MessageSend_0/clk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins dvi2rgb_0/RefClk]
  connect_bd_net -net comparaison_couleurs_0_Cerne1Present [get_bd_ports LED_cerne1] [get_bd_pins MessageSend_0/compCerne1] [get_bd_pins comparaison_couleurs_0/Cerne1Present]
  connect_bd_net -net comparaison_couleurs_0_Cerne2Present [get_bd_ports LED_cerne2] [get_bd_pins MessageSend_0/compCerne2] [get_bd_pins comparaison_couleurs_0/Cerne2Present]
  ...
  connect_bd_net -net dvi2rgb_0_PixelClk [get_bd_pins boite_0/CLK] [get_bd_pins comparaison_couleurs_0/clk] [get_bd_pins dvi2rgb_0/PixelClk] [get_bd_pins moyennage_0/clk] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins zonePeau_0/Pixel_Clk]
  connect_bd_net -net dvi2rgb_0_vid_pData [get_bd_pins dvi2rgb_0/vid_pData] [get_bd_pins moyennage_0/i_rgb] [get_bd_pins zonePeau_0/PIXEL_IN]
  ...
  connect_bd_net -net zonePeau_0_PIXEL_OUT [get_bd_pins boite_0/PIXEL_IN] [get_bd_pins zonePeau_0/PIXEL_OUT]
