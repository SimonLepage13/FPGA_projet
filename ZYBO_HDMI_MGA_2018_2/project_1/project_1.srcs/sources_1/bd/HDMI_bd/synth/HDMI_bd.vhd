...
architecture STRUCTURE of HDMI_bd is
  ...
  signal NLW_MessageSend_0_tx_UNCONNECTED : STD_LOGIC;
  ...
  signal NLW_transmetteur_UART_0_OCCUPE_UNCONNECTED : STD_LOGIC;
  signal NLW_transmetteur_UART_0_TERMINE_UNCONNECTED : STD_LOGIC;
  signal NLW_zonePeau_0_PIXEL_OUT_UNCONNECTED : STD_LOGIC_VECTOR ( 23 downto 0 );
...
begin
  CLK_1 <= CLK;
  UART_OUT <= transmetteur_UART_0_TX;
...
MessageSend_0: component HDMI_bd_MessageSend_0_0
     port map (
      ...
      resetUART => '1',
      signalStart => '0',
      tx => NLW_MessageSend_0_tx_UNCONNECTED
    );
...
transmetteur_UART_0: component HDMI_bd_transmetteur_UART_0_0
     port map (
      ...
      OCCUPE => NLW_transmetteur_UART_0_OCCUPE_UNCONNECTED,
      RESET => '0',
      START => '0',
      TERMINE => NLW_transmetteur_UART_0_TERMINE_UNCONNECTED,
...
zonePeau_0: component HDMI_bd_zonePeau_0_0
     port map (
      ...
      PIXEL_OUT(23 downto 0) => NLW_zonePeau_0_PIXEL_OUT_UNCONNECTED(23 downto 0),
