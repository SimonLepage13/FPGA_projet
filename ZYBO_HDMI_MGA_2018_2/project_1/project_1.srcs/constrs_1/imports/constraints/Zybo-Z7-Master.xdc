...
set_property IOSTANDARD LVCMOS33 [get_ports LED_cerne1]
set_property IOSTANDARD LVCMOS33 [get_ports LED_cerne2]
set_property IOSTANDARD LVCMOS33 [get_ports UART_OUT]
set_property PACKAGE_PIN V12 [get_ports LED_cerne1]
set_property PACKAGE_PIN W16 [get_ports LED_cerne2]
set_property PACKAGE_PIN W15 [get_ports UART_OUT]
